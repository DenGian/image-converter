...
Thanks for helping improve Image Converter.
...
4. Run `npm run format:check`, `npm run lint`, `npm run typecheck`, `npm test`, `npm run build`, `npm run size:check`, and `npm run test:e2e`.
